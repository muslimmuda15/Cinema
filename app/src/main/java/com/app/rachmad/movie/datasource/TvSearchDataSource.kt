...
class TvSearchDataSource : PageKeyedDataSource<Int, TvData> {
    var query: String = ""
    ...
    fun setData(query: String, resultFirst: List<TvData>, language: String){
        this.query = query
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, TvData>) {
        ...
        val call = service.tvSearch(this.query, page, language!!)
